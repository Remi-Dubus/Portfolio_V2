...
export default function ProjectCard(
    ...
    return (
        <section className="min-h-auto sm:h-140 lg:h-[60vh] lg:pt-3 2xl:pt-10">
            <Link href={`projects/${slug}`}>
                <figure className={`relative aspect-[4/3] -top-5 h-90 flex w-[80vw] mx-auto flex-col justify-center rounded-lg items-center group transition-all duration-1000 hover:opacity-100 hover:drop-shadow-[0_0_10px_#C6C6CF] hover:sm:drop-shadow-[0_0_15px_#C6C6CF] my-10 vsm:my-10 vsm:w-[68vw] sm:mt-24 sm:mb-4 sm:h-[25rem] sm:w-[36vw] lg:w-[16vw] lg:h-[47vh] lg:-top-14 hover:lg:scale-110 hover:lg:blur-none hover:lg:grayscale-0 ${index === activeSlide ? "z-30 lg:scale-110" : "z-20 lg:scale-90 lg:blur-sm lg:grayscale-100"}`}>
