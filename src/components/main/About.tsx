...
export default function About() {
    ...
    return (
        <article id="about" className="absolute top-[100vh] min-h-96 mb-18 p-1 sm:p-4 lg:relative lg:top-0 lg:h-screen lg:snap-start xl:flex xl:flex-col xl:px-20 2xl:px-45">
            <figure className="relative h-screen px-1 vsm:p-4">
