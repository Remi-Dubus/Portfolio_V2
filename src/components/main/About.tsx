...
export default function About() {
    ...
    return (
        <article id="about" className="h-fit mt-8 p-1 sm:p-4 lg:relative lg:pt-10 lg:h-screen lg:snap-start xl:flex xl:flex-col xl:px-20 2xl:px-45">
            <figure className="relative h-fit px-1 vsm:p-4 lg:my-2">
                <h2 className={`text-2xl text-interest text-center sm:text-4xl lg:relative lg:mt-10 lg:z-5 xl:mb-8 xl:text-5xl 2xl:mb-12 2xl:text-6xl ${titleFont.className}`}>{translations.about.aboutTitle}</h2>
                <Image
                    src="/remidubus.png"
                    alt="Rémi Dubus"
                    width={300}
