...
export default function NavBar (){
    ...
    return (
       <header>
           ...
           <nav className={`z-15 h-screen inset-0 overflow-x-hidden top-0 fixed transition-all duration-1000 bg-black/60 backdrop-blur-sm lg:overflow-x-hidden lg:h-20 ${openMenu ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none lg:opacity-100 lg:bg-black/0 lg:pointer-events-auto lg:backdrop-blur-none"}`}>
