...
export default function NavBar (){
    ...
    return (
       <header>
           ...
           <section className={`z-15 h-screen inset-0 overflow-auto top-0 fixed transition-all duration-1000 bg-black/60 backdrop-blur-sm lg:overflow-hidden ${openMenu ? "opacity-100 lg:pointer-events-auto" : "opacity-0 pointer-events-none lg:opacity-100 lg:bg-black/0 lg:backdrop-blur-none"}`}>
