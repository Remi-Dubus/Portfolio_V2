    ...
    return (
       <header>
           ...
           <section className={`z-15 h-screen inset-0 overflow-auto top-0 fixed transition-all duration-1000 bg-black/60 backdrop-blur-sm lg:overflow-hidden lg:h-20 ${openMenu ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none lg:opacity-100 lg:bg-black/0 lg:pointer-events-auto lg:backdrop-blur-none"}`}>
               ...
               <ul>
                   <li className="fixed bottom-10 flex justify-center gap-8 w-full sm:mb-6 lg:flex lg:justify-end lg:bottom-2 lg:mr-20 lg:w-fit lg:right-0.5 xl:bottom-1.5 xl:right-8 2xl:bottom-8 2xl:right-26">
                       <Link href={translations.link.gitHubLink}>
                           <svg
                               xmlns="http://www.w3.org/2000/svg"
                               viewBox="0 0 24 24"
                               fill="currentColor"
                               className="w-12 h-12 p-0.5 text-light cursor-pointer duration-300 active:scale-110 hover:text-interest sm:h-16 sm:w-16 lg:opacity-50 lg:hover:opacity-100 2xl:h-22 2xl:w-22"
                           >
                       ...
                       <Link href={translations.link.linkedinLink}>
                           <svg
                               ...
                               viewBox="0 0 50 50"
                               fill="currentColor"
                               className="w-12 h-12 text-light cursor-pointer duration-300 active:scale-110 hover:text-interest sm:h-16 sm:w-16 lg:opacity-50 lg:hover:opacity-100 2xl:h-22 2xl:w-22"
                           >
