...
export default function SwitchLanguageButton() {
    ...
    return <button onClick={toggleLanguage} className="fixed z-20 w-[3rem] h-[3rem] right-16 top-2 border-2 border-light rounded-lg shadow-shadow shadow-md sm:top-4 sm:right-20 sm:w-[3.5rem] sm:h-[3.5rem] lg:top-3 lg:right-4 lg:w-[3rem] lg:h-[3rem]">
