...
export default function Footer() {
    ...
    return (
        <footer className="relative h-30 text-sm flex mt-4 flex-col items-center text-light mx-auto justify-center border-t-2 w-5/6 gap-2 vsm:text-base vsm:h-36 sm:text-lg sm:py-8 lg:h-28 lg:fixed lg:bottom-0 lg:translate-x-1/2 lg:right-1/2 lg:text-xl 2xl:h-40">
